...
public class GeneralizacijaPainter extends ConnectionPainter {
    ...
    public void draw(Graphics2D g) {
        Generalizacija ge = (Generalizacija) element;
        ...
        if(point1 != null && point2!=null) {
            if (idx1 == 3) {///desno
                ...
                ((GeneralPath) shape).lineTo(point1.x + 8, point1.y + 8);
                ((GeneralPath) shape).lineTo(point1.x + 8, point1.y);
                ...
                ((GeneralPath) shape).moveTo(point1.x, point1.y);
                ((GeneralPath) shape).lineTo(point1.x+8, point1.y - 8);
                ((GeneralPath) shape).lineTo(point1.x, point1.y - 8);
                ((GeneralPath) shape).lineTo(point2.x, point2.y);
                ((GeneralPath) shape).lineTo(point1.x, point1.y - 8);
                ((GeneralPath) shape).lineTo(point1.x-8, point1.y - 8);
                ((GeneralPath) shape).lineTo(point1.x, point1.y);
